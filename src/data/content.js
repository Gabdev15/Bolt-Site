...
export const BOOKING_FLOW = {
  ...
  reviewsSuffix: 'avis',
  seatsSuffix: 'places',
  labelDate: 'Date de départ',
  labelTime: 'Heure de départ',
  labelDuration: 'Durée de conduite',
  labelDateShort: 'Date',
  labelTimeShort: 'Heure',
  labelDurationShort: 'Durée',
  labelAddress: 'Adresse',
  labelVehicle: 'Véhicule',
  labelPrice: 'Prix',
  labelTotal: 'Total',
  labelTax: 'Taxe',
  priceDetailTitle: 'Détail du prix',
};
